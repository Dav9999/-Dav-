...
const instagram = 'https://instagram.com/Dav_'; 
const telegram = 'https://t.me/Dav'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Dav_';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by #Dav_`)
})
